...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    /**
     * Finds utilizador by username
     *
     * @param string $username
     * @return static|null
     */
    public static function findByUsername($usernname)
    {
        return static::findOne(['username' => $usernname, 'status' => self::STATUS_ACTIVE]);
    }

    /**
     * Finds utilizador by password reset token
     *
