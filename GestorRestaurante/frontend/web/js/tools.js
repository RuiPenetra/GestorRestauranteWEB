...
function QuantEntregueIncrement(id) {
    ...
    document.getElementById('inputQuantPreparacao'+id).value =document.getElementById('inputQuantPreparacao'+id).value -document.getElementById('inputQuantEntregue'+id).value;
